...
public class DlgUsuario extends javax.swing.JDialog {
    ...
    * @param usuario Canción a capturar, editar o desplegar
    ...
    */
    public DlgUsuario(java.awt.Frame parent, String title, boolean modal, Usuario usuario, 
        ...
        if((operacion == ConstantesGUI.ELIMINAR) ||
          (operacion == ConstantesGUI.DESPLEGAR)) {
            ...
            campoTextoTelefono.setEnabled(false);
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Núm Credencial");
    ...
    private void botonAceptarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botonAceptarActionPerformed
        ...
        if ((operacion == ConstantesGUI.AGREGAR)
            ...
            usuario.setNumCredencial(campoTextoNumCredencial.getText());
        }
    ...
    private void botonRestaurarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botonRestaurarActionPerformed
        ...
        if(operacion == ConstantesGUI.AGREGAR) {
            ...
            campoTextoNumCredencial.setText("");
        }
        // Si la operación es Actualizar
        if(operacion == ConstantesGUI.ACTUALIZAR) {
            campoTextoNombre.setText(usuario.getNombre()); campoTextoDireccion.setText(usuario.getDireccion());
            campoTextoTelefono.setText(usuario.getTelefono()); campoTextoNumCredencial.setText(usuario.getNumCredencial());
        }
